...
namespace FustWebApp.Migrations
{
    ...
    [Migration("20230530085340_AdjustmentsV5")]
    partial class AdjustmentsV5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FustWebApp.Models.Domain.AdjustmentCodes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FustWebApp.Models.Domain.Loads", b =>
                {
                    ...
                    b.Property<Guid>("LoadSupplierId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FustWebApp.Models.Domain.Loads", b =>
                {
                    b.HasOne("FustWebApp.Models.Domain.Supplier", "LoadSupplier")
                        .WithMany()
                        .HasForeignKey("LoadSupplierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoadSupplier");
                });
